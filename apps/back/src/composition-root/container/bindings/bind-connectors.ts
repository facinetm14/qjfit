...
} from "@fetch-runs/infrastructure/adapters/output/connectors/france-travail/france-travail.connector.js";
import {
  FranceTravailAuthClient,
  type FranceTravailAuthClientOptions,
} from "@fetch-runs/infrastructure/adapters/output/connectors/france-travail/france-travail-auth.client.js";
import {
  WttjRssConnector,
  type WttjRssConnectorOptions,
} from "@fetch-runs/infrastructure/adapters/output/connectors/wttj-rss/wttj-rss.connector.js";
