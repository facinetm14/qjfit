...
import type { MatchTicketStorePort } from "@match/application/ports/match-ticket-store.port.js";
...
import type { MatchTicket } from "@match/domain/match-ticket.entity.js";
