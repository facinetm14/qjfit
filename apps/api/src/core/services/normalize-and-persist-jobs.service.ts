...
import { buildDedupKey } from "../jobs/normalization.js";

const DEFAULT_CONTRACT_TYPE = "Other";
const DEFAULT_REMOTE_POLICY = "Unknown";
...
export class NormalizeAndPersistJobsService implements NormalizeAndPersistJobsPort {
