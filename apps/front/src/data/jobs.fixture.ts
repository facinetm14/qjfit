...
export const MOCK_MATCHED_JOBS: readonly MatchedJob[] = [
  ...
  },
  {
    ...
    daysAgo: 1,
    summary:
      "Data-platform role with heavy Python/Airflow overlap; two days a week on-site in the 2nd arrondissement.",
  ...
  },
  {
    ...
    daysAgo: 0,
    summary:
      "Full-stack role pairing your Vue and Python experience almost one-for-one; fully remote-friendly.",
  ...
  },
  {
    ...
    daysAgo: 3,
    summary:
      "Solid Django/PostgreSQL overlap; on-site only, which narrows the fit slightly.",
  ...
  },
  {
    ...
    daysAgo: 4,
    summary:
      "Adjacent MLOps role — your Python background transfers, but the ML tooling stack is mostly new ground.",
  ...
  },
  {
    ...
    daysAgo: 5,
    summary:
      "Infra-leaning role — your containerisation basics carry over, but Go and Terraform depth is expected.",
  ...
  },
  {
    ...
    daysAgo: 6,
    summary:
      "Mostly Ansible-driven ops work with on-call rotation — limited overlap with your recent projects.",
    reasons: ["Docker"],
